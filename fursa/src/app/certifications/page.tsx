  ...
  return (
    <div className="container mx-auto py-16 px-4 max-w-3xl" dir="rtl">
      ...
      <ul className="list-disc pr-6 text-gray-800 space-y-2">
        <li>شهادات تقنية مثل AWS, PMP, CISSP.</li>
        <li>شهادات في الإدارة والموارد البشرية.</li>
        <li>شهادات مالية ومحاسبية معتمدة.</li>
        <li>روابط لمصادر التعلم والتسجيل في الاختبارات.</li>
      </ul>
    </div>
  );
} 